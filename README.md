...
<p align="center">
  <img src="assets/uos_m3_feasibility_report.png" alt="SolarScan Rooftop Solar Feasibility Report - University of Sharjah M3" width="80%" />
</p>
...
Here is an authentic report generated by SolarScan for **University of Sharjah M3, Sharjah, UAE**:

<p align="center">
  <img src="assets/uos_m3_feasibility_report.png" alt="SolarScan Report - University of Sharjah M3" width="85%" />
</p>
...
| :--- | :--- | :--- |
| **Target Address** | `University of Sharjah M3, Sharjah, UAE` | OpenStreetMap geocoded campus coordinates (`25.2891° N, 55.4800° E`) |
| **Raw Roof Footprint Area** | **`7695.84 m²`** | Computed via Shoelace formula from OSM polygon vertices |
| **Usable Roof Area (after Setback)** | **`6983.24 m²`** | Roof area remaining after $1.50\text{ m}$ fire-code perimeter setback |
...
| **Recommended DC Capacity** | **`1396.65 kW DC`** | $6983.24\text{ m}^2 \times 0.20\text{ kW/m}^2$ STC array rating |
| **Recommended Inverter Band (AC)** | **`1163.87 kW AC`** | Rated AC power at target $1.20$ DC/AC oversizing ratio |
| **Dominant Roof Azimuth** | **`78.9°`** | Angle derived from longest rooftop footprint edge relative to North |
| **Assumed Panel Tilt** | **`15°`** | Fixed commercial tilt angle optimal for UAE latitude |
| **Estimated Annual Energy Yield** | **`1,512,858.15 kWh/yr`** | Derived from $5.5\text{ PSH}$, orientation derate ($0.6348$), and $0.85$ system loss |
| **Utility Electricity Rate** | **`0.38 / kWh`** | Local grid tariff in AED / kWh |
| **Estimated Simple Payback** | **`2.43 years`** | Installed CAPEX vs annual electricity cost savings |
