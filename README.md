...
<p align="center">
  <img src="assets/uos_m13_feasibility_report.png" alt="SolarScan Rooftop Solar Feasibility Report - University of Sharjah M13" width="80%" />
</p>
...
Here is an authentic report generated by SolarScan for **University of Sharjah M13 (College of Fine Arts & Design), Sharjah, UAE**:

<p align="center">
  <img src="assets/uos_m13_feasibility_report.png" alt="SolarScan Report - University of Sharjah M13" width="85%" />
</p>
...
| :--- | :--- | :--- |
| **Target Address** | `University of Sharjah M13, Sharjah, UAE` | Tagged OSM Building Ref `M13` (`25.28871° N, 55.48051° E`) |
| **Raw Roof Footprint Area** | **`154.68 m²`** | Computed via Shoelace formula from OSM Building M13 polygon vertices |
| **Usable Roof Area (after Setback)** | **`74.83 m²`** | Roof area remaining after $1.50\text{ m}$ fire-code perimeter setback |
...
| **Recommended DC Capacity** | **`14.97 kW DC`** | $74.83\text{ m}^2 \times 0.20\text{ kW/m}^2$ STC array rating |
| **Recommended Inverter Band (AC)** | **`12.47 kW AC`** | Rated AC power at target $1.20$ DC/AC oversizing ratio |
| **Dominant Roof Azimuth** | **`170.5°`** | Angle derived from longest rooftop footprint edge relative to North |
| **Assumed Panel Tilt** | **`15°`** | Fixed commercial tilt angle optimal for UAE latitude |
| **Estimated Annual Energy Yield** | **`12,769.17 kWh/yr`** | Derived from $5.5\text{ PSH}$, orientation derate ($0.6348$), and $0.85$ system loss |
